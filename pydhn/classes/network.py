...
class Network(AbstractNetwork):
    ...
    def add_stratified_storage(
        ...
        **kwargs,
        ...
        positive value charges the tank, drawing hot water from the start
        node into the top, while a negative value discharges it.
        ...
        n_layers : int, optional
            Number of vertical layers. The default is {NL}.
        ...
        delta_k : float, optional
            ...
            account for destratification (W/(m·K)). The default is {DK}.
        t_ambient : float, optional
            Temperature of the ambient around the tank (°C). The default is
            {TA}.
        ...
        setpoint_value_hyd : float, optional
            Imposed mass flow (kg/s), positive to charge the tank. The
            default is {SVH}.
        stepsize : float, optional
        ...
        **kwargs : dict
        ...
        References
        ----------
        .. [1] Kleinbach, E. M., W. A. Beckman, and S. A. Klein. "Performance
           study of one-dimensional models for stratified thermal storage
           tanks." Solar Energy 50.2 (1993): 155-166.
